...
export function SideConfigBar() {
  ...
  return (
    <>
      {/* Desktop Sidebar */}
      <aside
        className={`hidden md:flex transition-all duration-300 ease-in-out z-40 flex-col bg-surface/50 border-r border-surface pt-6 h-full overflow-x-hidden select-none ${
