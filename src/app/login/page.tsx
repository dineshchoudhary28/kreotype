      ...
      {!otpSent && (
        <div className="flex flex-col gap-3 mb-8">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center justify-center gap-3 w-full px-4 py-3 rounded-xl bg-[#24292F] text-white font-bold hover:bg-[#24292F]/80 transition-all duration-200 text-sm disabled:opacity-50 cursor-pointer"
          >
